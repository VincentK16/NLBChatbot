...
: general ( -- "s")
   ...
   q{ 
        <h3><center>Why is the suggested nearby Hawker is not nearby at all?</center></h3>
        <h5><center>The nearby Hawker is the Hawker Center that is operated by NEA excluded those Kopitiam/Coffee Shops</center></h5>
       
        <h5><center>You can also feedback to us if you think there's a nearer Hawker Center that is nearer to what's suggested! Simply click on the "Feedback/Suggestions" button and leave your feedback/suggestions! I really appreciate it!</center></h5>
        <center>#{buttons}</center>
   }q
;
